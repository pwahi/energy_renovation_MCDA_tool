...
const sampleAlternatives = [
  { id: createId(), name: 'Basic insulation package', level: 'Basic', scores: { C1: 70, C2: 3, C4: 15, C5: 420, C6: 18000, C8: 62000, C9: 17, C10: 120, C12: 620 } },
  { id: createId(), name: 'Moderate envelope upgrade', level: 'Moderate', scores: { C1: 48, C2: 5, C4: 32, C5: 720, C6: 36000, C8: 76000, C9: 15, C10: 72, C12: 980 } },
  { id: createId(), name: 'Deep retrofit ready', level: 'Deep', scores: { C1: 32, C2: 7, C4: 58, C5: 1080, C6: 64000, C8: 91000, C9: 19, C10: 28, C12: 1410 } },
];
...
document.querySelector('#alternativeForm').addEventListener('submit', (event) => {
  event.preventDefault();
  const data = new FormData(event.currentTarget);
  state.alternatives.push({ id: createId(), name: data.get('name'), level: data.get('level'), scores: {} });
  event.currentTarget.reset();
  render();
});
